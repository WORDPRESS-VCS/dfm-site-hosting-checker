<?php
     ...
     */
    class bmi_bmr_result_list extends WP_List_Table {
    ...
    function bmi_bmr_result_list_function() {
        //initialization
        $class = new bmi_bmr_result_list();
        $class->prepare_items();
    ?>
    <div class="wrap">
        <p class="instructionp">Use <span class="instruction">[HUMAN_BMI_BMR]</span> as a Shortcode.</p>
        <h1 class="menupagebmibmrresult">Tested Patient List</h1>
        <style>
            h1.menupagebmibmrresult {
                text-align: center;
